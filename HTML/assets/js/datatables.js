...
function fnFormatDetails ( oTable, nTr )
{
	...
	var sOut = '<table cellpadding="5" cellspacing="5" border="0" style="padding-left:50px;width: 100%;" class="inner-table">';
	sOut += '<tr colspan="7"><td>';
	sOut += '<div class="row m-b-10"><div class="col-md-12 col-xs-12"><b>Email:</b>rohan@gmail.com</div>';
    sOut += '</div>';
	sOut += '<div class="row m-b-10"><div class="col-md-6 col-xs-6"><b>Added on :</b>01/02/2014</div><div class="col-md-6 col-xs-6"><b>Purchased on :</b>02/05/2014</div>';
    sOut += '</div>';
     sOut += '<div class="row m-b-10"><div class="col-md-12 col-xs-12"><b>Submited By:</b>Rohan Pawar</div>';
    sOut += '</div>';
	sOut += '<div class="row "><div class="col-md-6 m-b-10"><b>City:</b>Pune(Maharshtra)</div>';
    sOut += '<div class="col-md-6 m-b-10"><b>Interested in:</b><span class="label label-info">2Bhk</span> <span class="label label-info">3Bhk</span> </div></div>';
    sOut += '<div class="row "><div class="col-md-6 m-b-10"><b>Project name:</b>Songbird</div>';
	 sOut += '<div class="col-md-6 m-b-10"><b>Buying For:</b>Investment</div></div>';
   sOut += '</tr></td></table>';
