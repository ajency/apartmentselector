...
$(document).ready(function() {
    ...
    $('#example6 thead tr').each( function () {
	...
	$('#example6_wrapper .dataTables_filter input').addClass("input-medium ");
    $('#example6_wrapper .dataTables_length select').addClass("select2-wrapper span12"); 
     ...
     */
    $('#example6 tbody td i').live('click', function () {
...
function fnFormatDetails ( oTable, nTr )
{
    ...
    var sOut = '<table cellpadding="5" cellspacing="5" border="0" style="padding-left:50px;" class="inner-table">';
     sOut += '<tr><td><b>Added By:</b></td><td>Rohan Pawar</td><td>&nbsp;</td><td>&nbsp;</td>';
    sOut += '<td>&nbsp;</td><td>&nbsp;</td></tr>';
	sOut += '<tr><td><b>Last Updated:</b></td><td>12 march 2014</td><td>&nbsp;</td><td>&nbsp;</td>';
    sOut += '<td><b>Date Added:</b></td><td>10 march 2014</td></tr>';
  sOut += '</table>';
