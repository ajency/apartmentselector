...
define(['extm', 'marionette'], function(Extm, Marionette) {
  ...
  UnitView = (function(_super) {
    ...
    UnitView.prototype.template = '<div class="vs-content"> <div class="row"> <div class="col-sm-6 towerUnits"> <div class="subHeader"> <div class="row"> <div class="col-xs-5"> FLOOR<br>RANGE </div> <div class="col-xs-7 text-right"> NO. OF UNITS OF<br>YOUR SELECTION </div> </div> </div> </div> <div class="col-sm-6 b-grey b-l"> <div class="towerUnits psuedoUnits"></div> <div class="towerDetails"> <div class="row"> <div class="col-xs-4"> <h3 class="m-t-0 m-b-0">Total Apartments</h3> <h1 class="semi-bold m-t-5">{{totalunits}}</h1> </div> <div class="col-xs-4"> <h3 class="m-t-0 m-b-0">Available Apartments</h3> <h1 class="semi-bold m-t-5">{{availableunits}}</h1> </div> <div class="col-xs-4"> <h3 class="m-t-0 m-b-0">Number of Floors</h3> <h1 class="semi-bold m-t-5">{{totalfloors}}</h1> </div> </div> <div class="row"> <div class="col-sm-12 m-t-10"> <div class="col"> <p>Climb leg make muffins or sweet beast play time and hate dog or chew foot. Stretch climb leg. Play time give attitude for all of a sudden go crazy chase imaginary bugs lick butt. Claw drapes burrow under covers so hide when guests come over, inspect anything brought into the house hopped up on goofballs. Nap all day swat at dog and rub face on everything stick butt in face all of a sudden go crazy need to chase tail yet rub face on everything.</p> </div> </div> </div> <div class="row m-l-0 m-r-0 m-b-20"> <div class="col-xs-4"> <h4 class="m-t-0 text-primary">What can I<div class="bold">SEE?</div> </h4> </div> <div class="col-xs-4"> <span class="glyphicon glyphicon-asterisk small text-grey"></span> Garden view<br><span class="glyphicon glyphicon-asterisk small text-grey"></span> Pond View </div> <div class="col-xs-4"> <span class="glyphicon glyphicon-asterisk small text-grey"></span> Manas Lake<br><span class="glyphicon glyphicon-asterisk small text-grey"></span> Eco pond </div> </div> </div> </div> </div> </div>';
