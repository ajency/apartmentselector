...
define(['extm', 'marionette'], function(Extm, Marionette) {
  ...
  ScreenTwoLayout = (function(_super) {
    ...
    ScreenTwoLayout.prototype.template = '<div class="text-center introTxt">We have <span class="bold text-primary"> {{unitsCount }} options</span> for {{selection}} </div> <div class="text-center subTxt m-b-10">Just select your floors to get started</div> <div class="legend text-center m-b-20"> {{#unitType}} <span class="oneBHK">.</span>{{name}} {{/unitType}} </div> <div class="row m-r-0 m-l-0"> <div class="col-sm-7 p-l-0 p-r-0"> <div class="towerTable"> <div class="tableHeader"> <ul> <li><a href="#modal"><span class="bold">HIGHRISE</span><br>15-11 Floors</a></li> <li><a href="#modal"><span class="bold">MIDRISE</span><br>15-11 Floors</a></li> <li><a href="#modal"><span class="bold">LOWRISE</span><br>15-11 Floors</a></li> </ul> </div> <div class="tableBody"> <div id="vs-container2" class="vs-container"> <header class="vs-header"><div id="building-region"></div></header> <div id="unit-region"></div> </div> </div> </div> <div class="towerDetails"> <div class="row"> <div class="col-sm-12"> <img src="assets/img/towerA.jpg" class="img-responsive"> </div> </div> <div class="row"> {{#unitType}}         						<div class="col-xs-4"> <h1><small>Total {{name}}</small><br>{{count}}</h1> </div> {{/unitType}} </div> <div class="row"> <div class="col-sm-12 m-t-10"> <div class="col"> <p>Climb leg make muffins or sweet beast play time and hate dog or chew foot. Stretch climb leg. Play time give attitude for all of a sudden go crazy chase imaginary bugs lick butt. Claw drapes burrow under covers so hide when guests come over, inspect anything brought into the house hopped up on goofballs. Nap all day swat at dog and rub face on everything stick butt in face all of a sudden go crazy need to chase tail yet rub face on everything. Give attitude chew iPad power cord, and stick butt in face or chase imaginary bugs. Hate dog destroy couch or under the bed and nap all day. Hate dog flop over and missing until dinner time. Chew iPad power cord stick butt in face so leave hair everywhere. Stretch swat at dog. Stand in front of the computer screen hunt anything that moves yet behind the couch or lick butt intrigued by the shower. Give attitude hate dog but chase imaginary bugs sleep on keyboard or play time.</p> </div> </div> </div> </div> </div> <div class="col-sm-5 hidden-xs"> <h3 class="bold m-t-0">Climb leg make muffins or sweet</h3> <p>Claw drapes burrow under covers so hide when guests come over, inspect anything brought into the house hopped up on goofballs.</p> <img src="../../../.../../../HTML/assets/img/map1.jpg" class="img-responsive m-t-20"> </div> </div>';
  ...
  UnitTypeChildView = (function(_super) {
    ...
    UnitTypeChildView.prototype.template = '<ul class="vs-nav"></ul>';

    UnitTypeChildView.prototype.childView = BuildingView;

    UnitTypeChildView.prototype.childViewContainer = ".vs-nav";
  ...
  UnitView = (function(_super) {
    ...
    UnitView.prototype.template = '<section id="tower{{buildingid}}" class="hidden"> <div class="vs-content"> {{#units}}<div class="text-center"> <div class="flatNos">{{name}}</div> </div> {{/units}} </div> </section>';
  ...
  UnitTypeView = (function(_super) {
    ...
    UnitTypeView.prototype.template = '<div class="vs-wrapper">';

    UnitTypeView.prototype.childView = UnitView;

    UnitTypeView.prototype.childViewContainer = ".vs-wrapper";
