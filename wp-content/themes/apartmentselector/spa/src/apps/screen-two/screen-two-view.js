...
define(['extm', 'marionette'], function(Extm, Marionette) {
  ...
  ScreenTwoLayout = (function(_super) {
    ...
    ScreenTwoLayout.prototype.events = {
      ...
      'click .tower-link': function(e) {
        var element, floorColl, floorCollunits, floorUnitsArray, id, key, locationData, myArray, params, screenonearray, screenthreeArray, screentwoArray, status, str1, text, units, unitslen, _i, _j, _k, _len, _len1, _len2;
