...
define(['marionette'], function(Marionette) {
  ...
  return ScreenOneView = (function(_super) {
    ...
    ScreenOneView.prototype.template = '<h3 class="light text-center m-t-0">3 STEPS TO FINDING YOUR APARTMENT</h3> <h4 class="text-center introTxt">We at Skyi have built a unique apartment selector for you.<br>Of the hundreds of apartments available you can now find the one that best fits your requirements.</h4> <!--<div class="text-center introTxt">The apartment selector helps you find your ideal home. Browse through available apartments and find the location, size, budget and layout that best suit you.</div> <div class="introTxt text-center">To get started, either:</div>--> <div class="print-header hide"> <div class="row print-head"> <div class="col-sm-6 head"> <h1>Flat No: <strong>1201</strong></h1> </div> <div class="col-sm-6 head"> <h1>Tower 1</h1> </div> </div> <div class="row print-sub-head"> <div class="col-sm-6 head"> <h2>Flat Type: <strong>2BHK</strong>(975 to 1165 sq. ft.)</h2> </div> <div class="col-sm-6 head"> <h2>Floor Range: <strong>Highrise</strong></h2> </div> </div> </div> <div class="row m-l-0 m-r-0 bgClass"> <div class="col-md-5 col-lg-4"> <div class="web-view"> <div class="text-center subTxt">Choose a unit type</div> <div class="grid-container"></div> <!--<h5 class="text-center m-t-20 m-b-20 bold">OR</h5>--> <div id="showbudget" class="hidden"><div class="text-center subTxt">Choose a budget</div> <section> <select class="cs-select cs-skin-underline" id="budgetValue"> <option value="" disabled selected>Undecided</option> {{#priceArray}} <option value="{{id}}">{{name}}</option> {{/priceArray}} </select> </section></div> <div class="h-align-middle m-t-50 m-b-20"> <a href="#screen-two-region" class="btn btn-default btn-lg disabled" id="finalButton">Show Apartments</a> </div> </div> <div class="print-view hide"> Zoom View Image here </div> </div> <div class="col-md-7 col-lg-8 b-grey b-l visible-md visible-lg"> <div id="mapplic_new1" class="towersMap center-block"></div> </div><input type="hidden" name="currency" id="currency" class="demo" data-a-sign="Rs. " data-m-dec=""  data-d-group="2" > </div>';
