  ...
  ScreenThreeLayout = (function(_super) {
    ...
    ScreenThreeLayout.prototype.doListing = function() {
      ...
      $.each(tagsArray, function(index, value) {
        return $('#tagslist1 ul').append('<li id="li-item-' + value.id + '" data-itemNum="' + value.id + '">[<div class="closeButton">x</div><span class="itemText">' + value.area + '</span> ]</li>');
      });
