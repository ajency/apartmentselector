...
define(['marionette'], function(Mariontte) {
  ...
  PopItemview = (function(_super) {
    ...
    PopItemview.prototype.template = ' <ul> <li class="unitName"> <div class="small"> Tower 1</div>{{name}} </li> </ul> <!--BHK--> <ul> <li> {{unitTypeName}} </li> </ul> <!--Floor Info--> <ul> <li> {{flooRange}} </li> <li> {{floor}} </li> </ul> <!--View Info--> <ul> <li> {{facings}} </li> <li> {{views}} </li> </ul> <!--Area--> <ul> <li> 684 </li> <li> {{sellablearea}} </li> <li> {{carpetarea}} </li> </ul> <!--Room Area--> <ul> <li> - </li> <li> - </li> <li> - </li> <li> - </li> <li> - </li> <li> - </li> <li> - </li> <li> - </li> </ul> <!--Layouts--> <ul class="layouts"> <li> <a class="2dlayout" data-fancybox-group="2dlayout" title="2D Layout - 1001" href="../wp-content/themes/apartmentselector/spa/src/bower_components/fancybox/demo/1_b.jpg"><img src="../wp-content/themes/apartmentselector/spa/src/bower_components/fancybox/demo/1_s.jpg" alt=""></a> </li> <li> <a class="2dlayout" data-fancybox-group="2dlayout" title="2D Layout - 1001" href="../wp-content/themes/apartmentselector/spa/src/bower_components/fancybox/demo/2_b.jpg"><img src="../wp-content/themes/apartmentselector/spa/src/bower_components/fancybox/demo/2_s.jpg" alt=""></a> </li> <li> <a class="2dlayout" data-fancybox-group="2dlayout" title="2D Layout - 3001" href="../wp-content/themes/apartmentselector/spa/src/bower_components/fancybox/demo/3_b.jpg"><img src="../wp-content/themes/apartmentselector/spa/src/bower_components/fancybox/demo/3_s.jpg" alt=""></a> </li> </ul>';
