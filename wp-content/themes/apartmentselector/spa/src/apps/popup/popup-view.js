...
define(['marionette'], function(Mariontte) {
  ...
  PopItemview = (function(_super) {
    ...
    PopItemview.prototype.template = ' <ul> <li class="unitName"> {{name}}<span class="small"> T1</span> </li> </ul> <!--BHK--> <ul> <li> {{unitTypeName}} </li> </ul> <!--Floor Info--> <ul> <li> {{flooRange}} </li> <li> {{floor}} </li> </ul> <!--View Info--> <ul> <li> SE </li> <li> Lake </li> </ul> <!--Area--> <ul> <li> 684 </li> <li> {{sellablearea}} </li> <li> {{carpetarea}} </li> </ul>';
