...
define(['extm'], function(Extm) {
  ...
  mainView = (function(_super) {
    ...
    mainView.prototype.template = '<div id="notify" class="notifyBox" style="display:none;"> You have clicked on a box! </div> <!--<div>dfsfsfs</div>--> <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2"> <h3>My Menu</h3> <ul> <li><a href="#"><span class="glyphicon glyphicon-heart"></span> Wishlist</a> <ul class="menuWishlist" id="showWishlist"> </ul> </li> <a href="#" id="compare" class="compareBtn">Compare</a> </ul> <div id="comparetext">Compare Apartments here! You can add Apartments to your wish list by clicking on the \'Add to wish list\' button on the view Apartment page after you have made a selection! You can compare up to 4 apartments!</div> </nav> <div id="print-view"> <div class="print-header hide"> <div class="row print-head"> <div class="col-sm-6 head"> <h1>Flat No: <strong><span id="flatno"></span></strong></h1> </div> <div class="col-sm-6 head"> <h1 id="towerno"></h1> </div> </div> <div class="row print-sub-head"> <div class="col-sm-6 head"> <h2>Flat Type: <strong><span id="unittypename"></span></strong>(<span id="area"></span> sq. ft.)</h2> </div> <div class="col-sm-6 head"> <h2>Floor Range: <strong><span id="floorrise"></span></strong></h2> </div> </div> </div> </div> <div id="screen-one-region" class="section"> </div> <div id="screen-two-region" > </div> <div id="screen-three-region" > </div> <div id="screen-four-region" > </div>';
