...
define(['extm'], function(Extm) {
  ...
  mainView = (function(_super) {
    ...
    mainView.prototype.template = '<div id="notify" class="notifyBox" style="display:none;"> You have clicked on a box! </div> <!--<div>dfsfsfs</div>--> <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2"> <h3>My Menu</h3> <ul> <li><a href="#"><span class="glyphicon glyphicon-heart"></span> Wishlist</a> <ul class="menuWishlist" id="showWishlist"> </ul> </li> <a href="#" id="compare" class="compareBtn">Compare</a> </ul> <div id="comparetext">Compare Apartments here! You can add Apartments to your wish list by clicking on the \'Add to wish list\' button on the view Apartment page after you have made a selection! You can compare up to 4 apartments!</div> </nav> <div id="print-view" class="visible-print"> <div class="print-header"> <div class="row print-head"> <div class="col-sm-6 head"> <h1>Flat No: <strong><span id="flatno"></span></strong></h1> </div> <div class="col-sm-6 head"> <h1 id="towerno"></h1> </div> </div> <div class="row print-sub-head"> <div class="col-sm-6 head"> <h2>Flat Type: <strong><span id="unittypename"></span></strong>(<span id="area"></span> sq. ft.)</h2> </div> <div class="col-sm-6 head"> <h2>Floor Range: <strong><span id="floorrise"></span></strong></h2> </div> </div> </div> <div class="print-row"> <div class="row"> <div class="col-sm-5"> <img src="" id="zoomedinimage" /> </div> <div class="col-sm-7"> <div id="printmapplic1" class="towersMap center-block"></div> </div> </div> <div class="row"> <div class="col-sm-5"> <div id="floorlayoutbasic" ></div> </div> <div class="col-sm-7"> <div id="towerview" ></div> </div> </div> </div> <div class="print-row last"> <div class="row"> <div class="col-sm-5"> <div class="details room"> </div> <div class="row extra-details"> <div class="col-sm-4"> <h5>Terrace</h5> <span id="terrace"></span> </div> <div class="col-sm-4"> <h5>Facing</h5> <span id="printfacing"></span> </div> <div class="col-sm-4"> <h5>Views</h5> <span id="printview"></span> </div> </div> </div> <div class="col-sm-7"> <h4 class="layout-header">2D Layout</h4> <div class="details "> <img src="" id="twoDimage" /> </div> <h4 class="layout-header">3D Layout</h4> <div class="details "> <img src="" id="threeDimage" /> </div> </div> </div> </div> </div> <div id="screen-one-region" class="section"> </div> <div id="screen-two-region" > </div> <div id="screen-three-region" > </div> <div id="screen-four-region" > </div>';
