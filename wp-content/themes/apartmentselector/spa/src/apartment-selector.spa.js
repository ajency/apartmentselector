...
define('plugin-loader', ['slick'], function() {});
...
require(['spec/javascripts/fixtures/json/units', 'spec/javascripts/fixtures/json/views', 'spec/javascripts/fixtures/json/buildings', 'spec/javascripts/fixtures/json/unitvariants', 'spec/javascripts/fixtures/json/unittypes', 'spec/javascripts/fixtures/json/range', 'spec/javascripts/fixtures/json/status', 'plugin-loader', 'extm', 'src/classes/ap-store', 'src/apps/router', 'apps-loader'], function(units, views, buildings, unitvariants, unittypes, range, status, plugins, Extm) {
  var staticApps;
